  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">
        Crafting Spaces Building Legacies our Portfolio
      </p>
      {/* sliders buttons */}
      <div className="flex justify-end items-center mb-8">
        <button
          ...
          aria-label="Previoud Project"
        >
          <img src={assets.left_arrow} alt="leftArrow" />
        </button>
        <button
          onClick={nextProject}
          className="p-3 bg-gray-200 rounded mr-2 "
        ...
        >
          <img src={assets.right_arrow} alt="rightArrow" />
        </button>
      </div>
